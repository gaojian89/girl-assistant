...
public class IntentUtils {
	 ...
	 *            图集中需要的起始页，缺省为0即可。
	 */
	public static void jumpToDetailActivity(Context context, String itemId, String type, int pictureStartPosition) {
		Intent intent = getIntentToDetailActivity(context, itemId, type, pictureStartPosition);
		context.startActivity(intent);
	}

	public static Intent getIntentToDetailActivity(Context context, String itemId, String type, int pictureStartPosition) {
		return null;
	}
