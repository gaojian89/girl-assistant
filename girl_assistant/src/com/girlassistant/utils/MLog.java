...
import com.girlassistant.activity.BuildConfig;
...
public final class MLog {
	...
	public static void httpPost(String pre, String url, Map<String, String> map) {
		String log = url + "?";
	...
	public static void showUrlPost2Get(String url, Map<String, String> map) {
		String getUrl = urlPost2Get(url, map);
		i(getUrl);
	}
