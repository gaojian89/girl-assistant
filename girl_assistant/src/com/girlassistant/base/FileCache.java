...
public class FileCache {
	...
	public static String getAppCollectDirectory() {
		return App.getInstance().getCacheDir() + "data/";
	}
	...
	public static final String DEFAULT_LOGO_NAME = "com_peopledailychina_logo.png";
